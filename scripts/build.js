...
function themeInitScript() {
  return `<script>(function(){try{var k='bd1ahn-theme',t=localStorage.getItem(k);if(t!=='light'&&t!=='dark')t=window.matchMedia('(prefers-color-scheme:light)').matches?'light':'dark';document.documentElement.setAttribute('data-theme',t)}catch(e){document.documentElement.setAttribute('data-theme','dark')}})();</script>`;
}

function renderThemeToggle() {
  return `<button type="button" class="theme-toggle" id="themeToggle" aria-label="切换浅色模式" title="浅色模式">
